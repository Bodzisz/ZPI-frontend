...
import {
  ...
  Loader,
  Center,
  Container, Input, Paper,
} from "@mantine/core";
import { Attraction } from "../../api/interfaces/Attraction";
import { useSelectedAttractionContext } from "../../SelectedAttractionContext";
import { addAttractionComment,addAttractionRating, deleteComment,
  fetchAtrractionById, fetchAttractionsCommentsByID, fetchAttractionsRatingsByID,
